...
//videdo
$urlvideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyASe-WTBIXs1XGo_RsDDLV4MOV9e3ldxr8&channelId=UCEe1ees-scoEkTQv3he9PJw&maxResults=20&part=snippet&order=date';
$result = get_curl($urlvideo);

$latestvideo5 = $result['items'][5]['id']['videoId'];
$judul5 = $result['items'][5]['snippet']['title'];
$desc5 = $result['items'][5]['snippet']['description'];
