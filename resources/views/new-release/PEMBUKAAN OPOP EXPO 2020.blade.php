...
//videdo
$urlvideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyBIXfUwTaH32vqMXYr-4ZUNa3YRMnxEPaE&channelId=UCEe1ees-scoEkTQv3he9PJw&maxResults=20&part=snippet&order=date';
$result = get_curl($urlvideo);

$latestvideo5 = $result['items'][17]['id']['videoId'];
$judul5 = $result['items'][17]['snippet']['title'];
$desc5 = $result['items'][17]['snippet']['description'];
        ...
        <div class="row">
            <div class="col">
                <div class="feature-img">
                    <iframe src="https://youtube.com/embed/<?= $latestvideo5; ?>?rel=0" allowfullscreen width="100%"></iframe>
                    <h2> <?= $judul5; ?> </h2>
