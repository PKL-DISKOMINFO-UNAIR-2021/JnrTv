...
//videdo
$urlvideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyDq4rKu_Ow-Q-lrYHBl1leGyF77aajVgQA&channelId=UCEe1ees-scoEkTQv3he9PJw&maxResults=100&part=snippet&order=date';
$result = get_curl($urlvideo);

$explore = $result['items'][44]['id']['videoId'];
$judul = $result['items'][44]['snippet']['title'];
$desc = $result['items'][44]['snippet']['description'];
